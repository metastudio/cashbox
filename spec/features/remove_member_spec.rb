...
describe 'delete transaction', js: true do
  ...
  context 'when member with owner role' do
    ...
    context 'owner can remove members with admin role' do
    ...
    context 'owner can remove members with user role' do
  ...
  context 'when member with admin role' do
    ...
    context 'admin can remove other members with admin role' do
    ...
    context 'admin can remove members with user role' do
      let!(:member_user) { create :member, :user, user: other_user, organization: org }
