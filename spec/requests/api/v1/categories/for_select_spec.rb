...
describe 'GET /api/organizations/#/categories/for_select' do
  let(:path) { "/api/organizations/#{organization.id}/categories/for_select" }
  ...
  context 'authenticated as owner' do
    ...
    it 'returns categories for select' do
