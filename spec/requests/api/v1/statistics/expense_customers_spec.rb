...
describe 'GET /api/organizations/#/statistics/expense_customers' do
  ...
  let!(:customer1_exp_transaction1) do
    create(:transaction, customer: customer1, bank_account: rub_ba, category: exp_category, date: current_month + rand(25), amount: 300_001.99)
  end
  let!(:customer1_exp_transaction2) do
    create(:transaction, customer: customer1, bank_account: usd_ba, category: exp_category, date: current_month + rand(25))
  end
  let!(:customer1_exp_transaction3) do
    create(:transaction, customer: customer1, bank_account: rub_ba, category: exp_category, date: previous_month + rand(25))
  end
  let!(:customer2_exp_transaction1) do
    create(:transaction, customer: customer2, bank_account: usd_ba, category: exp_category, date: current_month + rand(25))
  end
  let!(:customer2_exp_transaction2) do
    create(:transaction, customer: customer2, bank_account: eur_ba, category: exp_category, date: current_month + rand(25))
  end
  let!(:customer2_inc_transaction) do
    create(:transaction, customer: customer2, bank_account: eur_ba, category: inc_category, date: current_month + rand(25))
  end
  let!(:inc_customer_inc_transaction) do
    create(:transaction, customer: inc_customer, bank_account: rub_ba, category: inc_category, date: current_month + rand(25))
  end
